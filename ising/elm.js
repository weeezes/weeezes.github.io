...
Elm.Main.make = function (_elm) {
   ...
   var numberInputWithLabel = F4(function (label,placeholder,value,signal) {
      return A2($Html.tr,
      _U.list([]),
      _U.list([A2($Html.td,_U.list([]),_U.list([$Html.text(label)]))
              ,A2($Html.td,
              _U.list([]),
   ...
   var ChangeConfiguration = function (a) {    return {ctor: "ChangeConfiguration",_0: a};};
   var ChangeHeight = function (a) {    return {ctor: "ChangeHeight",_0: a};};
   ...
   var spinToDiv = function (spin) {
      ...
      if (_p9.ctor === "Up") {
            ...
            return A2($Html.div,
            _U.list([$Html$Attributes.$class("spinDown")
                    ,$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "width",_1: "30px"}
                                                    ,{ctor: "_Tuple2",_0: "height",_1: "30px"}
   ...
   var Downs = {ctor: "Downs"};
   var Ups = {ctor: "Ups"};
   var view = F2(function (address,model) {
      return A2($Html.div,
      _U.list([]),
      _U.list([A2($Html.table,
              _U.list([$Html$Attributes.style(_U.list([{ctor: "_Tuple2",_0: "display",_1: "box"}]))]),
              _U.list([A4(numberInputWithLabel,"Width: ","Width",model.width,function (str) {    return A2($Signal.message,address,ChangeWidth(str));})
                      ,A4(numberInputWithLabel,"Height: ","Height",model.height,function (str) {    return A2($Signal.message,address,ChangeHeight(str));})
                      ,A4(numberInputWithLabel,
                      "Interaction strength: ",
                      "Interaction strength",
                      model.interactionStrength,
                      function (str) {
                         return A2($Signal.message,address,ChangeInteractionStrength(str));
                      })
                      ,A4(numberInputWithLabel,
                      "Field strength: ",
                      "Field strength",
                      ...
                      function (str) {
                         return A2($Signal.message,address,ChangeMagneticFieldStrength(str));
                      })
                      ,A4(numberInputWithLabel,
                      "Temperature: ",
                      "Temperature",
              ...
              function (r) {
                 return A2($Html.tr,_U.list([]),$Array.toList(r));
              },
              A2($Array.map,
              function (r) {
                 return A2($Array.map,function (c) {    return A2($Html.td,_U.list([]),_U.list([spinToDiv(c)]));},r);
              },
              model.spinMatrix))))]));
   });
   var Down = {ctor: "Down"};
